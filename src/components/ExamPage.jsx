...
export default function ExamPage() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      setSourceQuestions(parsed.questions || []);
      setMeta(parsed.meta || { sem: "—", subj: "—", mod: "—" });
    } catch (error) {
  ...
  const allQuestions = sourceQuestions;
  ...
  if (phase === "result" && result) {
    return <ResultScreen result={result} meta={meta} onBack={() => router.push("/")} />;
  }
